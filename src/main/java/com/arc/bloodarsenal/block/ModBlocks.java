...
import com.arc.bloodarsenal.item.ItemBloodStoneBlock;
...
public class ModBlocks
{
    ...
    public static void init()
    {
        ...
        blood_door_wood = new BlockInfusedWoodenDoor(Material.wood);
    }

    public static void registerBlocksInPre()
    {
        GameRegistry.registerBlock(ModBlocks.blood_stone, ItemBloodStoneBlock.class, "BloodArsenal" + (ModBlocks.blood_stone.getUnlocalizedName().substring(5)));
