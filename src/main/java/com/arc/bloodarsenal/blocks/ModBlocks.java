...
public class ModBlocks
{
    ...
    public static Block blood_infused_redstone_lamp;
    ...
    public static void init()
    {
        ...
        blood_infused_redstone_lamp = new BlockBloodInfusedRedstoneLamp();
    ...
    public static void registerBlocksInPre()
    {
        ...
        GameRegistry.registerBlock(ModBlocks.blood_infused_redstone_lamp, "blood_infused_redstone_lamp");
