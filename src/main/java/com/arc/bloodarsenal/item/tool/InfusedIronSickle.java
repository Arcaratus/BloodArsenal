...
public class InfusedIronSickle extends ItemTool implements IBindable
{
    private int energyUsed;

    private int radiusLeaf = 2;
    private int radiusCrop = 3;
    ...
    public InfusedIronSickle(ToolMaterial toolMaterial)
    {
        super(1.0F, toolMaterial, toolBlocks);
        setUnlocalizedName("blood_infused_sickle_iron");
        setTextureName("BloodArsenal:blood_infused_sickle_iron");
        setMaxStackSize(1);
        setMaxDamage(0);
        setFull3D();
    ...
    public boolean onBlockDestroyed(ItemStack par1ItemStack, World par2World, Block par3Block, int x, int y, int z, EntityLivingBase par7EntityLivingBase)
    {
        ...
        {
            EnergyItems.syphonBatteries(par1ItemStack, player, 75);
        }
    ...
    public boolean onItemUse(ItemStack par1ItemStack, EntityPlayer par2EntityPlayer, World par3World, int x, int y, int z, int par7, float par8, float par9, float par10)
    {
        ...
        {
            EnergyItems.syphonBatteries(par1ItemStack, par2EntityPlayer, 75);
        }
