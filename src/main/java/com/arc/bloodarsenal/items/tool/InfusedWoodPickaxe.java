...
public class InfusedWoodPickaxe extends ItemPickaxe implements IBindable
{
    private int energyUsed;

    public InfusedWoodPickaxe()
    {
        super(BloodArsenal.infusedWood);
        setMaxStackSize(1);
        setUnlocalizedName("blood_infused_pickaxe_wood");
        setTextureName("BloodArsenal:blood_infused_pickaxe_wood");
