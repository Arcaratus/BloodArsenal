...
public class InfusedIronShovel extends ItemSpade implements IBindable
{
    private int energyUsed;

    public InfusedIronShovel()
    {
        super(BloodArsenal.infusedIron);
        setMaxStackSize(1);
        setUnlocalizedName("blood_infused_shovel_iron");
        setTextureName("BloodArsenal:blood_infused_shovel_iron");
