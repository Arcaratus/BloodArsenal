...
public class InfusedDiamondShovel extends ItemSpade implements IBindable
{
    ...
    public InfusedDiamondShovel()
    {
        ...
        setMaxStackSize(1);
        setUnlocalizedName("blood_infused_shovel_diamond");
        setTextureName("BloodArsenal:blood_infused_shovel_diamond");
    ...
    public boolean onBlockStartBreak(ItemStack par1ItemStack, int x, int y, int z, EntityPlayer par5EntityPlayer)
    {
        ...
        if (!ToolCapabilities.isRightMaterial(mat, ToolCapabilities.materialsShovel))
        {
            return false;
        }
        ...
        switch (ToolCapabilities.getMode(par1ItemStack))
        {
            ...
            case 1:
            {
                ...
                ToolCapabilities.removeBlocksInIteration(par5EntityPlayer, world, x, y, z, xo >= 0 ? 0 : -10, yo >= 0 ? 0 : -10, zo >= 0 ? 0 : -10, xo > 0 ? 10 : 1, yo > 0 ? 10 : 1, zo > 0 ? 10 : 1, null, ToolCapabilities.materialsShovel);
                break;
            }
            case 2:
            {
                ...
                ToolCapabilities.removeBlocksInIteration(par5EntityPlayer, world, x, y, z, doX ? -2 : 0, doY ? -1 : 0, doZ ? -2 : 0, doX ? 3 : 1, doY ? 4 : 1, doZ ? 3 : 1, null, ToolCapabilities.materialsShovel);
                break;
            }
        }
        return false;
