...
public class ContainerAugmentedHolding extends Container
{
    ...
    public ContainerAugmentedHolding(EntityPlayer player, InventoryAugmentedHolding inventoryHolding)
    {
        ...
        {
            this.addSlotToContainer(new SlotHolding(this, inventoryHolding, player, columnIndex, 8 + columnIndex * 18, 15));
        }
    ...
    public ItemStack transferStackInSlot(EntityPlayer entityPlayer, int slotIndex)
    {
        ...
        if (slotObject != null && slotObject.getHasStack())
        {
            ...
            else if (stack.getItem() instanceof SigilAugmentedHolding)
            {
