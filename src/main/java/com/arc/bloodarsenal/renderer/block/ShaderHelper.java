...
public final class ShaderHelper
{
    ...
    {
        beam = createProgram(null, "/assets/bloodarsenal/shaders/beam.frag");
    }
    ...
    public static void useShaderWithProps(int shader, Object... props)
    {
        ...
        if (shader != 0 && props.length % 2 == 0)
        {
            ...
            for (int i = 0; i < propCount; i++)
            {
                ...
                if (propVal instanceof Integer) ARBShaderObjects.glUniform1iARB(uniform, (Integer) propVal);
                if (propVal instanceof Float) ARBShaderObjects.glUniform1fARB(uniform, (Float) propVal);
            }
        }
    }
