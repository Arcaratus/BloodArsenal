...
public class ModRecipes
{
    ...
    public static void addSanguineInfusionRecipes()
    {
        ...
        SanguineInfusionRecipeRegistry.registerModificationRecipe(10000, Constants.Modifiers.CRIT_STRIKER, 1, p(Items.QUARTZ, 8), p(EnumBaseTypes.BLOOD_INFUSED_GLOWSTONE_DUST.getStack(), 8), p(Items.FLINT, 8), p(EnumBaseTypes.GLASS_SHARD.getStack(), 8), p(RegistrarBloodArsenalItems.BLOOD_DIAMOND, 8), p(Blocks.OBSIDIAN, 8), p(new ItemStack(RegistrarBloodArsenalBlocks.SLATE, 1, 3), 8), p(Items.PRISMARINE_SHARD, 8));
