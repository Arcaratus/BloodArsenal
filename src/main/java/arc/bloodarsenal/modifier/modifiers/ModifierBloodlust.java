...
public class ModifierBloodlust extends Modifier
{
    ...
    public Multimap<String, AttributeModifier> getAttributeModifiers()
    {
        ...
        multimap.put(SharedMonsterAttributes.ATTACK_DAMAGE.getAttributeUnlocalizedName(), new AttributeModifier(ATTACK_DAMAGE_MODIFIER, "Weapon modifier", Math.floor(multiplier / 4 + 1) * (6 + 0.5 * (getLevel() + 1)) * Math.pow(1.1375, multiplier), 0));
