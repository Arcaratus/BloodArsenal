...
public class ModifierQuickDraw extends Modifier
{
    ...
    public Multimap<String, AttributeModifier> getAttributeModifiers()
    {
        ...
        multimap.put(SharedMonsterAttributes.ATTACK_SPEED.getAttributeUnlocalizedName(), new AttributeModifier(ATTACK_SPEED_MODIFIER, "Tool modifier", (getLevel() + 1) * 2 / 4, 0));
