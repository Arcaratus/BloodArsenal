            ...
            if (itemStack != null && itemStack.getItem() instanceof IModifiableItem)
            {
                ...
                if (modifiable != null)
                {
                    ...
                    for (Entry<String, Modifier> entry : modifierMap.entrySet())
                    {
                        ...
                        modifier.writeSpecialNBT(modifierStack, ItemStack.loadItemStackFromNBT(itemStack.getTagCompound().getCompoundTag(Constants.NBT.ITEMSTACK)));
                        ...
                        if (successful)
                        {
                            ...
                            world.spawnEntityInWorld(new EntityItem(world, pos.getX() + 0.5, pos.getY() + 1.5, pos.getZ() + 0.5, modifierStack));
