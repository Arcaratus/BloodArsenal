...
public class ModRecipes
{
    ...
    public static void addCraftingRecipes()
    {
        ...
        addOreDictBloodOrbRecipe(new ItemStack(ModItems.STASIS_PLATE), "aaa", "aba", "cdc", 'a', ModBlocks.BLOOD_STAINED_GLASS, 'b', ModItems.REAGENT_LIGHTNING, 'c', new ItemStack(getBMItem(BloodMagicItem.SLATE), 1, 1), 'd', magicianOrb);
        addOreDictBloodOrbRecipe(new ItemStack(ModBlocks.STASIS_PLATE), "aaa", "aba", "cdc", 'a', ModItems.STASIS_PLATE, 'b', getBMBlock(BloodMagicBlock.ALTAR), 'c', new ItemStack(getBMItem(BloodMagicItem.SLATE), 1, 2), 'd', magicianOrb);
...
//        addForgeRecipe(new ItemStack(ModItems.SIGIL_AUGMENTED_HOLDING), 2000, 600, ItemComponent.getStack(ItemComponent.REAGENT_HOLDING), getBMItem(BloodMagicItem.SIGIL_HOLDING), new ItemStack(Blocks.CHEST, 8), "leather");
    ...
    {
        SanguineInfusionRecipeRegistry.registerSanguineInfusionRecipe(new ItemStack(ModItems.BLOOD_DIAMOND), 50000, new ItemStack(Items.DIAMOND), ModItems.BLOOD_INFUSED_STICK, ModItems.BLOOD_INFUSED_STICK, ModItems.BLOOD_INFUSED_STICK, ModItems.BLOOD_INFUSED_STICK, ModItems.BLOOD_INFUSED_STICK, ModItems.BLOOD_INFUSED_STICK, ModItems.BLOOD_INFUSED_STICK, ModItems.BLOOD_INFUSED_STICK);
        SanguineInfusionRecipeRegistry.registerSanguineInfusionRecipe(new ItemStack(ModItems.STASIS_AXE), 50000, new ItemStack(getBMItem(BloodMagicItem.BOUND_AXE)), ModItems.BLOOD_INFUSED_IRON_AXE, ModItems.STASIS_PLATE, ModItems.BLOOD_DIAMOND, ModItems.STASIS_PLATE, new ItemStack(ModBlocks.SLATE, 1, 2), ModItems.STASIS_PLATE, ModItems.BLOOD_DIAMOND, ModItems.STASIS_PLATE);
