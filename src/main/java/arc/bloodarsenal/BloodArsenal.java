...
@Mod(modid = BloodArsenal.MOD_ID, version = BloodArsenal.VERSION, name = "Blood Arsenal", dependencies = "required-after:BloodMagic;after:Baubles;after:Guidepi", guiFactory = "arc.bloodarsenal.client.gui.config.ConfigGuiFactory")
