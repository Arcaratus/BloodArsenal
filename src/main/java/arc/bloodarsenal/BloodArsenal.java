...
@Mod(modid = BloodArsenal.MOD_ID, version = BloodArsenal.VERSION, name = "Blood Arsenal", dependencies = "required-after:BloodMagic;required-after:Baubles;required-after:guideapi", guiFactory = "arc.bloodarsenal.client.gui.config.ConfigGuiFactory")
