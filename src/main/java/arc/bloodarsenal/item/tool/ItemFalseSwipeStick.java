...
public class ItemFalseSwipeStick extends ItemSword implements IVariantProvider
{
    public ItemFalseSwipeStick(String name)
    {
    ...
    {
        if (I18n.hasKey("tooltip.BloodArsenal.falseSwipeStick.desc"))
            tooltip.add(TextHelper.localizeEffect("tooltip.BloodArsenal.falseSwipeStick.desc"));
    }
