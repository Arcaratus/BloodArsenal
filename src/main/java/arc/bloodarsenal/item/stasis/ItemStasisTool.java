        ...
        if (equipmentSlot == EntityEquipmentSlot.MAINHAND)
        {
            ...
            else
            {
                ...
                if (hasShadow)
                {
                    ...
                    map.put(SharedMonsterAttributes.ATTACK_DAMAGE.getAttributeUnlocalizedName(), new AttributeModifier(ATTACK_DAMAGE_MODIFIER, "Weapon modifier", 2.7 * (modifier.getLevel() + 1) / 5, 0));
