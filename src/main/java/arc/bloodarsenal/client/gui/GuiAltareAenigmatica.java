...
public class GuiAltareAenigmatica extends GuiContainer
{
    ...
    {
        this.fontRenderer.drawString(TextHelper.localize("tile.bloodarsenal.altareAenigmatica.name"), 43, 6, 4210752);
        this.fontRenderer.drawString(TextHelper.localize("container.inventory"), 7, 71, 4210752);
